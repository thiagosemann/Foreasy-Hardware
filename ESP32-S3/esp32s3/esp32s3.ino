// ============================================================================
// Foreasy ESP32-S3
// Hardware: ESP32-S3 + shield relé 30A
//
// SISTEMA: Industrial — controle direto de energia (relay ON/OFF)
//   O backend liga ou desliga o relay; o relay libera ou corta a energia.
//
...
//
// PINOS (ESP32-S3 — strapping: GPIO0, GPIO3, GPIO45, GPIO46):
// - relayPin : GPIO2
// - ledPin   : GPIO4
// ============================================================================
...
<header>
  ...
  <div class="sub">smart device · esp32-s3</div>
</header>
<main>
  <div class="menu">
    ...
    <a class="lnk" href="/restart"><div><div>Reiniciar</div><div class="desc">reinicia o ESP32-S3</div></div><span class="arr">→</span></a>
  </div>
</main>
