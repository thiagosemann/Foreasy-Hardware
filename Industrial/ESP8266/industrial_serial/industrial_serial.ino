...
#define FW_CHIP    "esp8266"   // ESP-01S (Modelos 1 e 5)
...
// Sem prints no Serial: a Serial é exclusiva do relé (STC15F104W).
...
// ======================== HTTP pages =========================
// Páginas (PROGMEM, servidas por send_P para poupar RAM no ESP-01S).
...
static void handleInfoPage() {
  ...
  // Status do relé (via Serial) — durante o pulso fica ON
  bool physOn = relayInvert ? !pulseActive : pulseActive;
